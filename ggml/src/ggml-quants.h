...
GGML_API void quantize_row_znq2_ref(const float * GGML_RESTRICT x, block_znq2 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_znq3_ref(const float * GGML_RESTRICT x, block_znq3 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_znq4_ref(const float * GGML_RESTRICT x, block_znq4 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_znq2(const block_znq2 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_znq3(const block_znq3 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_znq4(const block_znq4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_znq2(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_znq3(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_znq4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
