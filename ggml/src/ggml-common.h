...
#define QK_ZNQ 32
typedef struct {
    uint8_t d;     // unsigned E5M3-like block scale
    uint8_t books; // low nibble: weights 0..15, high nibble: weights 16..31
    uint8_t qs[QK_ZNQ/4];
} block_znq2;
static_assert(sizeof(block_znq2) == 10, "wrong znq2 block size/padding");

typedef struct {
    uint8_t d;
    uint8_t books;
    uint8_t qs[3*QK_ZNQ/8];
} block_znq3;
static_assert(sizeof(block_znq3) == 14, "wrong znq3 block size/padding");
...
static_assert(sizeof(block_znq4) == 18, "wrong znq4 block size/padding");
...
// ZNQ v1 canonical nonlinear books. Trained on Mistral-7B-v0.3 BF16 and
// validated unchanged on Qwen3-30B-A3B, DeepSeek-V2-Lite and Mixtral-8x7B.
...
GGML_TABLE_BEGIN(int8_t, kvalues_znq3, 128)
    -66, -41, -22, -7, 7, 22, 41, 66,
    -79, -50, -27, -8, 8, 27, 49, 79,
    -89, -55, -30, -10, 9, 29, 55, 90,
    -114, -56, -30, -9, 10, 29, 53, 89,
    -88, -55, -32, -10, 9, 30, 55, 119,
    -108, -58, -26, -4, 16, 35, 62, 117,
    -99, -68, -39, -14, 8, 31, 63, 99,
    -124, -64, -39, -16, 7, 31, 58, 99,
    -95, -62, -34, -8, 17, 42, 70, 123,
    -121, -62, -29, -4, 19, 42, 72, 106,
    -118, -75, -40, -15, 6, 30, 64, 121,
    -105, -64, -39, -16, 10, 40, 77, 116,
    -120, -80, -40, -13, 15, 40, 66, 100,
    -121, -72, -36, -7, 18, 44, 82, 120,
    -115, -78, -47, -20, 7, 39, 76, 121,
    -120, -85, -49, -15, 17, 50, 85, 119,
GGML_TABLE_END()
...
GGML_TABLE_BEGIN(int8_t, kvalues_znq4, 256)
    ...
    -108, -72, -51, -37, -26, -17, -10, -3, 3, 10, 17, 26, 37, 51, 73, 108,
    -118, -77, -55, -39, -28, -18, -11, -4, 3, 10, 18, 27, 39, 53, 72, 118,
    -125, -76, -57, -41, -29, -19, -11, -4, 3, 11, 19, 29, 40, 55, 79, 126,
    -124, -81, -59, -43, -30, -20, -11, -4, 4, 11, 19, 30, 42, 60, 79, 109,
    -108, -80, -61, -44, -32, -21, -12, -4, 4, 12, 21, 31, 44, 61, 86, 125,
    -125, -87, -63, -46, -33, -22, -13, -5, 3, 12, 22, 33, 47, 61, 79, 122,
    -122, -82, -62, -48, -34, -23, -13, -4, 4, 13, 22, 34, 47, 68, 87, 125,
    -115, -92, -66, -49, -35, -23, -13, -4, 5, 14, 23, 35, 47, 65, 88, 112,
    -125, -87, -68, -50, -36, -24, -14, -4, 5, 14, 24, 36, 53, 67, 91, 117,
    -124, -92, -71, -53, -39, -26, -15, -5, 5, 15, 25, 38, 51, 70, 87, 125,
    -125, -94, -73, -55, -40, -27, -16, -5, 5, 16, 27, 40, 55, 70, 98, 123,
    -116, -95, -75, -58, -42, -29, -17, -6, 5, 17, 28, 42, 57, 77, 94, 123,
    -124, -100, -77, -61, -46, -32, -19, -7, 5, 18, 31, 45, 60, 76, 99, 123,
    -124, -105, -85, -68, -52, -37, -22, -7, 8, 23, 38, 53, 68, 84, 105, 124,
GGML_TABLE_END()
