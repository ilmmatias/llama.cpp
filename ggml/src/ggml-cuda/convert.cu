...
to_bf16_cuda_t ggml_get_to_bf16_cuda(ggml_type type) {
    switch (type) {
        case GGML_TYPE_ZNQ2:
            return dequantize_block_cont_cuda<QK_ZNQ, 1, dequantize_znq<2>>;
        case GGML_TYPE_ZNQ3:
            return dequantize_block_cont_cuda<QK_ZNQ, 1, dequantize_znq<3>>;
        case GGML_TYPE_ZNQ4:
            return dequantize_block_cont_cuda<QK_ZNQ, 1, dequantize_znq<4>>;
        case GGML_TYPE_Q1_0:
...
to_fp16_nc_cuda_t ggml_get_to_fp16_nc_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_ZNQ2:
            return dequantize_block_cuda<QK_ZNQ, 1, dequantize_znq<2>>;
        case GGML_TYPE_ZNQ3:
            return dequantize_block_cuda<QK_ZNQ, 1, dequantize_znq<3>>;
        case GGML_TYPE_ZNQ4:
            return dequantize_block_cuda<QK_ZNQ, 1, dequantize_znq<4>>;
        case GGML_TYPE_Q1_0:
