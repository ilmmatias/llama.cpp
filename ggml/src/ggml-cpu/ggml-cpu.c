...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_ZNQ2] = {
        .from_float               = quantize_row_znq2,
        .vec_dot                  = ggml_vec_dot_znq2_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_ZNQ3] = {
        .from_float               = quantize_row_znq3,
        .vec_dot                  = ggml_vec_dot_znq3_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_ZNQ4] = {
        .from_float               = quantize_row_znq4,
        .vec_dot                  = ggml_vec_dot_znq4_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_IQ4_XS] = {
...
static void ggml_compute_forward(struct ggml_compute_params * params, struct ggml_tensor * tensor) {
    ...
    switch (tensor->op) {
        ...
        case GGML_OP_MOE_REDUCE:
            {
                ggml_compute_forward_moe_reduce(params, tensor);
            } break;
